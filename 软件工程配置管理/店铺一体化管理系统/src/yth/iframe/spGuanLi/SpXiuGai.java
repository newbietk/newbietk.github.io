...
public class SpXiuGai extends JPanel{
	...
	public SpXiuGai(){
		...
		initGysBox();
		gysMingCheng.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	...
	private void doGysSelectAction() {// “选择供应商”下拉列表的选项事件
		...
		if (!(gysMingCheng.getSelectedItem() instanceof Item)) {// “选择供应商”下拉列表中的选项不是数据公共类的一个实例
			return;// 退出应用程序
		}
		selectedItem = (Item) gysMingCheng.getSelectedItem();// 获得“选择供应商”下拉列表中的选项
