...
public class MenuBar extends JMenuBar{
	...
	public JMenuItem getSpxiugaiItem(){
		if(spxiugai_Item == null){
			...
			spxiugai_Item.setText("商品修改");
			spxiugai_Item.addActionListener(new java.awt.event.ActionListener(){
				public void actionPerformed(java.awt.event.ActionEvent e){
					createIFrame(sptianjia_Item,ShangPinXiuGai.class);
				}
			});
		}
	...
	//初始化 客户管理菜单
	public JMenu getKehu_Menu(){
		if(kehu_Menu == null){
			kehu_Menu = new JMenu();
			kehu_Menu.setText("客户管理(G)");
			kehu_Menu.setMnemonic(KeyEvent.VK_G);
			kehu_Menu.add(getKhTianJiaItem());
			kehu_Menu.add(getKhSheZhiItem());
		}
		return kehu_Menu;
	}
	
	//初始化添加客户 菜单项
	public JMenuItem getKhTianJiaItem() {
		if(khtianjia_Item == null){
			khtianjia_Item = new JMenuItem();
			khtianjia_Item.setText("添加客户");
			khtianjia_Item.addActionListener(new java.awt.event.ActionListener(){
				public void actionPerformed(java.awt.event.ActionEvent e){
					createIFrame(khtianjia_Item, TianJiaKh.class);
				}
			});
		}
		return khtianjia_Item;
	}
	
	//初始化 客户设置菜单项
	public JMenuItem getKhSheZhiItem() {
		if(khshezhi_Item == null){
			khshezhi_Item = new JMenuItem();
			khshezhi_Item.setText("客户设置");
			khshezhi_Item.addActionListener(new java.awt.event.ActionListener(){
				public void actionPerformed(java.awt.event.ActionEvent e){
					createIFrame(khshezhi_Item, SetKHz.class);
				}
			});
		}
		return khshezhi_Item;
	}
	...
	public JMenuItem getTianjiaygItem(){
		if(tianjiayg_Item == null){
			...
			tianjiayg_Item.addActionListener(new java.awt.event.ActionListener(){
				public void actionPerformed(java.awt.event.ActionEvent e){
					createIFrame(tianjiayg_Item,YuanGongTianJia.class);
				}
			});
		}
	...
	public JMenuItem getSetygItem(){
		if(ygset_Item == null){
			...
			ygset_Item.addActionListener(new java.awt.event.ActionListener(){
				public void actionPerformed(java.awt.event.ActionEvent e){
					createIFrame(ygset_Item,YuanGongSheZhi.class);
				}
			});
		}
		return ygset_Item;
