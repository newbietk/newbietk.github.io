		...
		tjButton.addActionListener(new ActionListener() {// “添加”按钮动作事件的监听
			public void actionPerformed(final ActionEvent e) {
				...
				if(GysNameF.getText().equals("")) {
					JOptionPane.showMessageDialog(GysTianJia.this, "供应商名称为空");
					return ;
				}
				if(GysAddressF.getText().equals("")) {
					JOptionPane.showMessageDialog(GysTianJia.this, "供应商地址为空");
					return ;
				}
				if(GysMailF.getText().equals("")) {
					JOptionPane.showMessageDialog(GysTianJia.this, "供应商邮箱为空");
					return ;
				}
				if(GysTelF.getText().equals("")) {
					JOptionPane.showMessageDialog(GysTianJia.this, "供应商电话为空");
					return ;
				}
				if(GysBatF.getText().equals("")) {
					JOptionPane.showMessageDialog(GysTianJia.this, "供应商银行账户为空");
					return ;
				}
				if ( GysTaxF.getText().equals("")) {
					JOptionPane.showMessageDialog(GysTianJia.this, "供应商纳税号为空");
					return;
				}
				// 执行SQL查询语句获得的结果集
