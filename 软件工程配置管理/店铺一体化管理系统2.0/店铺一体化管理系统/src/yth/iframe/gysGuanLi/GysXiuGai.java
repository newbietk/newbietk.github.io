...
public class GysXiuGai extends JInternalFrame {// 供应商修改面板
		...
		modifyButton.addActionListener(new ActionListener() {// “修改”按钮动作事件的监听
			public void actionPerformed(ActionEvent e) {
				...
				if (Dao.updateGys(gysInfo) == 1)// 更改供应商信息的数量等于1
					JOptionPane.showMessageDialog(GysXiuGai.this, "修改完成");// 弹出提示框
				
				else// 更改供应商信息的数量不等于1
					JOptionPane.showMessageDialog(GysXiuGai.this, "修改失败");// 弹出提示框
			}
		});
	}
