	...
	public SpTianJia() {// 商品添加面板
		...
		tjButton.addActionListener(new ActionListener() {// 为“添加”按钮添加动作事件的监听
			public void actionPerformed(final ActionEvent e) {
				// 文本框为空时，弹出提示框
				if (mingCheng.getText().equals("")) {
					JOptionPane.showMessageDialog(SpTianJia.this, "商品名称不能为空。", "商品添加",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
				if(chanDi.getText().equals("")){
					JOptionPane.showMessageDialog(SpTianJia.this, "产地不能为空。", "商品添加",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
				
				if(danWei.getText().equals("")|| shuLiang.getText().equals("")){
					JOptionPane.showMessageDialog(SpTianJia.this, "单位不能为空。", "商品添加",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
				
				if(danJia.getText().equals("")){
					JOptionPane.showMessageDialog(SpTianJia.this, "单价不能为空。", "商品添加",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
				
				if(shuLiang.getText().equals("")){
					JOptionPane.showMessageDialog(SpTianJia.this, "数量不能为空。", "商品添加",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
